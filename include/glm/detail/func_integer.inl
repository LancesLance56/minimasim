...
#	endif//GLM_HAS_BITSCAN_WINDOWS
	...
	{
		GLM_STATIC_ASSERT(sizeof(uint) == sizeof(uint32), "uint and uint32 sizeOfMesh mismatch");
	...
	{
		GLM_STATIC_ASSERT(sizeof(int) == sizeof(int32), "int and int32 sizeOfMesh mismatch");
