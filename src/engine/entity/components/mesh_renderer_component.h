...
public:
    ...
    void
    draw(const glm::mat4 &mvp, const Camera &camera, std::span<const Light> lights, const Material &material) const;

    void draw(const glm::mat4 &mvp, const Camera &camera, std::span<const Light> lights) const;
};
