...
public:
    ...
    void set_render_settings(const RenderSettings& rs) override {
        render_settings = rs;
    }
    ...
    void add_component(Args&&... args) {
        auto component_ptr = std::make_unique<NBodySim::MassComponent>(
            transform.position, std::forward<Args>(args)...);
